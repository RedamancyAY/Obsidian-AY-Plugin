...
class SincConv_fast(nn.Module):
    ...
    def __init__(self, out_channels, kernel_size, sample_rate=16000, in_channels=1,
        ...
        n_ = 2*math.pi*torch.arange(-n, 0).view(1, -1) / self.sample_rate # Due to symmetry, I only need half of the time axes
...
class RawNet2(nn.Module):
    def __init__(self, d_args):
        ...
        self.block1 = nn.Sequential(Residual_block_wFRM(nb_filts = [d_args['filts'][1][1]] * 2))
        ...
        self.block5 = nn.Sequential(Residual_block_wFRM(nb_filts = [d_args['filts'][3][1]] * 2))
    ...
    def get_main_stem(self):
        return [self.first_conv, self.first_bn, self.lrelu_keras, self.block0,self.block1,self.block2,self.block3,self.block4,self.block5,
                self.bn_before_gru]
