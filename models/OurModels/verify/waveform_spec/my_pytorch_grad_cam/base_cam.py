...
class BaseCAM:
    ...
    def forward(
        ...
        print("CAM, model outputs: ", outputs.shape)
    ...
    def compute_cam_per_layer(
        ...
        print("CAM, activations: ", [a.cpu().data.numpy().shape for a in self.activations_and_grads.activations])
        print("CAM, grads: ",  [g.cpu().data.numpy().shape for g in self.activations_and_grads.gradients])
        ...
        print("CAM, target size", target_size)
