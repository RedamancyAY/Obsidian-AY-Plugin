...
class RawGAT_ST(nn.Module):
    def __init__(self, d_args, device, num_classes=1):
        super().__init__()
        self.device=device
        ...
        # self.proj2 = nn.Linear(23,12) # For input [B, 64600]
        self.proj2 = nn.Linear(17,12) # For input [B, 48000]
        ...
        self.proj_node = nn.Linear(7,num_classes)
    ...
    def forward(self, x, Freq_aug=False):
        ...
        x_pool2=self.pool2(x_gat2).transpose(1,3)
        out2=self.proj2(x_pool2)
